package Inheritance;
	...
	class PersonInheritance{
		public static void main(String[] args) {
			Student1 s =new Student1("Payal",22,"Female",97650954,18,95,"A");
			s.display();
			System.out.println();
			Teacher t=new Teacher("Roshini",34,"Female",96651954,111,"Science",70000,5);
			t.display();
			System.out.println();
			Doctor d=new Doctor("Vedant",30,"Male",94215369,"Neurosurgeon","AIIMS",5000);
			d.display();
			System.out.println("Person total count:"+Person.getCount());
		} 
	}
